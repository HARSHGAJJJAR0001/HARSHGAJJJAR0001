...
- 🌐 I am a passionate software engineer focused on building clean, scalable, and user-centric digital experiences.
- 🛠️ Currently working on deep-dive backend solutions and interactive modern frontends.
- 📚 Continuous learner actively exploring Cloud-Native Technologies and AI integration.
- ⚡ Fun fact: I drink coffee to compile code, and compile code to buy coffee.
